# Double Asteroid Redirection Test Mission (dart:) Local Dictionary
...
are located at https://pds-data-dictionaries.github.io/ldd-dart.

# Latest Release

* Download dictionary files from the [PDS Data Dictionaries Page](https://pds.nasa.gov/datastandards/dictionaries/#dart)
...
* **[docs](docs)/** - This directory contains the source and build files
for the documentation site on github.io.
...
Search for the \[ldd-dart\] update request block and click the green
"Get Started" button.
